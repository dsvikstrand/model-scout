      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <header className="text-center mb-10">
          <h1 className="text-4xl font-bold tracking-tight text-foreground flex items-center justify-center gap-2">
            <span className="animate-shimmer bg-gradient-to-r from-indigo-500 via-slate-300 to-indigo-800 bg-clip-text text-transparent drop-shadow-[0_0_16px_rgba(129,140,248,0.35)]">
              Model
            </span>
            <span className="animate-shimmer bg-gradient-to-r from-indigo-500 via-slate-300 to-indigo-800 bg-clip-text text-transparent drop-shadow-[0_0_16px_rgba(56,189,248,0.35)]">
              Scout
            </span>
          </h1>
